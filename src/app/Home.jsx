...
const Home = () => {
  return (
    <section
      id="home"
      className="min-h-screen bg-black px-4 sm:px-6 md:px-10 
      py-12 pt-24 flex flex-col md:flex-row  justify-between gap-10"
    >
      {/* Text Section */}
      <div
        ...
        data-aos="fade-right"
      >
        <h1 className="text-3xl sm:text-4xl  md:text-5xl pt-40 lg:text-6xl text-[#C0A062] font-extrabold leading-tight">
        ...
        <div>
          <button
            className="mt-4 px-6 py-3 text-sm sm:text-base bg-[#C0A062] text-white rounded-full shadow 
